...
{
    public class TrueRainbowThread : ModItem
    {
        ...
        public override string Texture => "TextilesAndCo/Content/Items/Thread/RainbowThread";
        ...
        {
            spriteBatch.Draw(ModContent.Request<Texture2D>("TextilesAndCo/Content/Items/Thread/Thread").Value, position, frame, Main.DiscoColor, 0f, Vector2.Zero, scale, SpriteEffects.None, 0);
